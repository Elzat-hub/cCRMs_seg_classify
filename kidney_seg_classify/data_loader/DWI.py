...
class DWI(Dataset):
    def __init__(self, mode, dataset_path="../data"):
        ...
        self.train_path = self.root + '/DWI/train/image'
        self.train_seglabel_path = self.root + '/DWI/train/label'
        self.train_classlabel_path = self.root + '/train_classify_label.csv'
        self.test_path = self.root + '/DWI/val/image'
        self.test_seglabel_path = self.root + '/DWI/val/label'
